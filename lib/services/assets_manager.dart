...
// general images
  ...
  // Categories path
  static String ub = "$categoriesImagesPath/UB.png";
  static String mayuri = "$categoriesImagesPath/mayuri.png";
  static String boys = "$categoriesImagesPath/boys.png";
  static String girls = "$categoriesImagesPath/girls.png";
}
